...
from constants.game_constants import IMPORTANT_CARDS, CardDataTypes, SpecialTypes, CardTypes
...
def card_portrait_to_card(new_card_portrait: Image, card_position: int)->Card|None:
    ...
    print("No matching card portrait found")

def hand_to_cards(window_handler, stat_handler: GameStatHandler)->list[Card|None]:
